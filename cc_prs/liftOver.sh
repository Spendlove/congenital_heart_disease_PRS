...
ls noheader2.common.heart_valve_disorders.txt
ls $chainfile
$liftOver -bedPlus=3 noheader2.common.abnormal_heart_sounds.txt $chainfile Lifted2.common.abnormal_heart_sounds.txt Unlifted2.common.abnormal_heart_sounds.txt
$liftOver -bedPlus=3 noheader2.common.heart_valve_disorders.txt $chainfile Lifted2.common.heart_valve_disorders.txt Unlifted2.common.heart_valve_disorders.txt
